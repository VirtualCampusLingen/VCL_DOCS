...
\begin{description}
  ...
  %ToDo: Heißt der Meilenstein wirklich so?
  ...
  %ToDo: Ist das der Name des Meilenstein?
  ...
  % TODO: Titel der anderen Ausarbeitung ändern?
  ...
  Zur Übergabe der Software gehört zudem eine Dokumentation der Funktionsweise, die im \verweis{Projektdokumentation} vorgestellt wird. Der Abschluss dieser Phase stellt damit den Abschluss des Projektes dar.
