...
\newcommand{\tabelleEinfg}[3] % Parameter: caption, label, file
{\begin{table}[htbp]
\centering
\singlespacing
\input{Tabellen/#3}
...
% Fontstyle einer ganzen Tabellenzeile ändern
\usepackage{array}
...
% Stile für Tabellenzeilen
\newcommand{\header}{\rowcolor{heading}\rowstyle{\bfseries}}
\newcommand{\result}{\rowcolor{heading}\rowstyle{\itshape}}
